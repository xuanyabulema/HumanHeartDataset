- [Human Heart Dataset](#head1)
- [[Cardiac Atlas Project](http://www.cardiacatlas.org/)](#head2)
	- [[Motion Tracking Challenge（运动追踪挑战）](http://www.cardiacatlas.org/challenges/motion-tracking-challenge/)](#head3)
		- [Data](#head4)
		- [Ground truth](#head5)
		- [Additional files](#head6)
		- [ Contacts](#head7)
- [Human Heart Project](#head8)
	- [Multimodality STRAUS](#head9)
	- [ Overview](#head10)
		- [ Objectives](#head11)
		- [ Methodology](#head12)
	- [Open-access database](#head13)
		- [Get Started](#head14)
		- [ Download](#head15)
			- [Download Collection (Option 1)](#head16)
			- [Download Collection (Option 2)](#head17)
			- [Download Selected Folders](#head18)
	- [R&D Team](#head19)

# <span id="head1">Human Heart Dataset</span>
...
# <span id="head2">[Cardiac Atlas Project](http://www.cardiacatlas.org/)</span>

![image-20220922142621049](README/image-20220922142621049.png)

## <span id="head3">[Motion Tracking Challenge（运动追踪挑战）](http://www.cardiacatlas.org/challenges/motion-tracking-challenge/)</span>
...
### <span id="head5">Ground truth</span>
...
### <span id="head6">Additional files</span>
...
# <span id="head8">Human Heart Project</span>

## <span id="head9">Multimodality STRAUS</span>
...
### <span id="head11"> Objectives</span>
...
### <span id="head12"> Methodology</span>
...
## <span id="head13">Open-access database</span>
...
### <span id="head14">Get Started</span>
...
### <span id="head15"> Download</span>

You can download the entire collection of images or specific images.

#### <span id="head16">Download Collection (Option 1)</span>
...
#### <span id="head17">Download Collection (Option 2)</span>
...
#### <span id="head18">Download Selected Folders</span>
